...
import GuestLayout from '@/Layouts/GuestLayout.vue'; // <--- Layout imported here

// Navbar logic has been migrated to the Layout. Keeping only Scroll Reveal effects here.
onMounted(() => {
...
<template>
    ...
    <GuestLayout>
        ...
        <!-- About Section -->
        <section id="sobre" class="py-16 lg:py-24 bg-[#FAF8F5] scroll-mt-16">
                    ...
                    <div class="grid sm:grid-cols-2 gap-8 mb-10">
                        <div class="flex gap-4 items-start group">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 leading-relaxed">Técnicas updated para o caimento perfeito.</p>
                            </div>
                        </div>
        ...
        <!-- Services Section -->
        <section id="servicos" class="py-16 lg:py-24 bg-white scroll-mt-10">
            <div class="mx-auto max-w-7xl px-6 lg:px-12 text-center">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
                    ...
                    <!-- Service Card: Hairstyling and Makeup -->
