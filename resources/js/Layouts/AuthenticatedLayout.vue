...
import { Menubar, Avatar, Button, Menu, Toast } from 'primevue'; // <-- Toast added here
import { router } from '@inertiajs/vue3';

const toastPosition = ref('top-right');

// Adjust toast placement based on viewport width to improve mobile UX
...
const items = [
    ...
    // --- Mobile-exclusive options (md:hidden) ---
    { separator: true, class: 'md:hidden' }, // Divider line
    { isProfileHeader: true, class: 'md:hidden' }, // Block containing user name and email
            ...
            <header>
                <Menubar
                    ...
                    <template #item="{ item, props }">
                        ...
                        <!-- Profile block inside the mobile menu layout -->
                        ...
                        <Button
                            ...
                            <i v-if="item.icon" :class="[item.icon, 'mr-2', item.action === 'logout' ? 'text-red-500' : 'text-gray-500']" />
                            <span
                                :class="[
                                    'font-medium py-1',
